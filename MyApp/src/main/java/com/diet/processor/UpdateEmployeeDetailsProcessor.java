 ...
 *
 */
@Component("updateEmployeeDetailsProcessor")
public class UpdateEmployeeDetailsProcessor extends BaseProcessor {
	...
	public Object processRequest(HttpServletRequest request, HttpServletResponse response, Object jsonRequest) {
		...
		try {
			myDietDAOImpl.updateEmpDetails((EmployeeDetailsBean)jsonRequest);
